function hoverNavLink() {
  const hover = document.querySelector('nav#navbar a:hover').id;

  document.getElementById(hover).style.animation = 'navBarHover ease-in 500ms';

  document.getElementById(hover).style.color = '#c1c7ca';
}
